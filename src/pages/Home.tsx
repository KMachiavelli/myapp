...
const Home = () => {
    ...
    return (
        <StyledHome breakpoint={breakPointContext}>
            <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae ipsum, dolores repellat a eaque quae fugiat magnam saepe rerum corrupti sint hic magni exercitationem cupiditate ut id optio animi possimus?</h1>
        </StyledHome>
    )
}
